...
void BackgroundEffect::Initialize(int _tile_effect)
{
	timeStar = 0;
	delayStar = 0;
	if (_tile_effect == ccSpriteID::SPRITE_MAP_1)
	{
		this->m_Sprite = new CSprite(*SpriteManager::getInstance()->getSprite(ccSpriteID::SPRITE_EFFECT_MAP1)); 
	}
	if (_tile_effect == ccSpriteID::SPRITE_MAP_2)
	{
		this->m_Sprite = new CSprite(*SpriteManager::getInstance()->getSprite(ccSpriteID::SPRITE_EFFECT_MAP2)); 
	}
	if (_tile_effect == ccSpriteID::SPRITE_MAP_3)
	{
		this->m_Sprite = new CSprite(*SpriteManager::getInstance()->getSprite(ccSpriteID::SPRITE_EFFECT_MAP3)); 
	}
}
